...
.controller('MainController', function ($scope, $rootScope, $http, $timeout, $location/**, cfpLoadingBar*/) {
	...
	$rootScope.getDeviceData = function(deviceId) {
		if (!deviceId) return;
		$http.get("http://172.21.76.225:8999/get/" + deviceId).success(function(data) {
		// $http.get("http://localhost:63342/ace_dashboard/angular/data/pages/devicedetails/devicedetails.json").success(function(data) {
