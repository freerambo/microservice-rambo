angular.module('AceApp',['rzModule']).controller('SldCtrlDemo', function($scope,$rootScope,$stateParams, $location, $timeout,$http, $uibModal,$interval,$filter, $localStorage) {
	...
	$scope.offStatus = "icons/on-16x16.png";
...
//start the websocket services
	...
	$scope.start = function () {
		alert("going to start the entire system");
	};

	$scope.stop = function () {
		alert("going to stop the entire system");
