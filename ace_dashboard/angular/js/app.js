...
var app = angular
  ...
  .config(function ($stateProvider, $urlRouterProvider, $ocLazyLoadProvider/**, cfpLoadingBarProvider*/) {
	...
	.state('ui.deviceDetails', {
		url: '/devicedetails/:deviceId',
		title: 'Device Details',

		templateUrl: 'views/pages/deviceDetails.html',
		...
		resolve: {
			lazyLoad: ['$ocLazyLoad', function($ocLazyLoad) {
				return $ocLazyLoad.load([
					{
						name: 'AceApp',
						files: ['js/controllers/pages/deviceDetails.js']
					}]);
			}]
		}
	  ...
	  .state('form.form-wizard', {
		...
		.state('form.form-wizard1', {
			url: '/form-wizard1',
			title: 'Form Wizard1',

			templateUrl: 'views/pages/form-wizard1.html',
			...
			resolve: {
				lazyLoad: ['$ocLazyLoad', function($ocLazyLoad) {
					return $ocLazyLoad.load([{
						...
						{
							name: 'AceApp',
							files: ['js/controllers/pages/form-wizard1.js']
						},
						{
							name: 'AceApp',
							insertBefore: '#main-ace-style',
	...
	/*  .state('widgets', {
					...
					return $ocLazyLoad.load([
						{
							...
							name: 'sortable',
							files: ['../components/_mod/jquery-ui.custom/jquery-ui.custom.js', '../components/jqueryui-touch-punch/jquery.ui.touch-punch.js',
								'../components/highcharts/highstock.js',
								'../components/highcharts/exporting.js'
							]
						},

						{
							name: 'AceApp',
							files: ['js/controllers/pages/devices.js']
						},
						{
							name: 'AceApp',
							files: [
        ...
        .state('sld.demo', {
            url: '/sld/demo',
            title: 'Demo System',
            controller: 'SldCtrlDemo',
            templateUrl: 'views/pages/sld.html',
            resolve: {
                lazyLoad: ['$ocLazyLoad', function($ocLazyLoad) {
                    return $ocLazyLoad.load([
                        {
                            name: 'highcharts',
                            files: ['../components/highcharts/highcharts.js']
                        },{
                            name: 'maingridcss',
                            files: ['css/pages/grid-main-page.css']
                        },{
                            name: 'rzslider',
                            files: [
                                '../components/rzslider/rzslider.js',
                                '../components/rzslider/rzslider.css'
                            ]
                        },
                        {
                            name: 'maingridjs',
                            files: [
                                'js/controllers/pages/sld-demo.js'
                            ]
                        }
                    ]);
                }]
  ...
  .run(function($rootScope) {
	  $rootScope.smargrid_version = "2.1";
	  $rootScope.serverUrl = "http://172.21.76.225:8998/";
	  $rootScope.wsServerUrl = "ws://172.21.76.225:8999/pm";
	  $rootScope.convWsServerUrl = "ws://172.21.76.225:8899/conv";
	  $rootScope.gridsimulatorUrl = "http://172.21.76.225:9999/api/grid/";

	  $rootScope.autostart = "http://172.21.76.225:8989/";
  });
