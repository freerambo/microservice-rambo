...
public class VariableResource {
	...
	public Variable addVariable(@PathParam("deviceId") int deviceId, Variable variable) {
		return VariableHelper.addVariable(deviceId, variable);
	}
