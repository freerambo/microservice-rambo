...
CREATE TABLE `device_variable` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_device_variable_device_1` (`device_id`),
  KEY `fk_device_variable_variable_1` (`variable_id`),
  CONSTRAINT `fk_device_variable_device_1` FOREIGN KEY (`device_id`) REFERENCES `device` (`id`),
  CONSTRAINT `fk_device_variable_variable_1` FOREIGN KEY (`variable_id`) REFERENCES `variable` (`id`)
